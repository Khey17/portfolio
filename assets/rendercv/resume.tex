...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Member of a research software engineering team building an on-premise LLM assistant for University of Delaware students, faculty, and staff.}
        \resumeItem{Benchmarking LLM inference and serving performance (throughput, latency, model selection) on NVIDIA DGX hardware to inform deployment decisions.}
      \resumeItemListEnd
