...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Research Associate, Scientific Machine Learning}{Jun 2025 -- Present}
      {Department of Mathematical Sciences, University of Delaware \, (Advisor: Dr.\ Ke Chen)}{Newark, DE}
      \resumeItemListStart
        \resumeItem{Developing hybrid classical and neural solvers for semilinear elliptic PDEs: learned surrogates that replace iterative Newton solves with a single forward pass, amortizing solution cost across problem instances (manuscript in preparation).}
        \resumeItem{Built the project's end-to-end research infrastructure: high-precision ground-truth generation via Chebyshev spectral discretizations and Newton iteration, automated dataset-validation suites, and reproducible PyTorch training and evaluation pipelines.}
